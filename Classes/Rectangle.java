 ...
 * @author amrze
 */
public class Rectangle extends Details {

    public Rectangle(int x, int y, int height, int width, Color color, Color fillColor) {
        super(x, y);
        setColor(color);
    ...
    public String toString() 
    {
        String line=null;
        try{
             line="Rectangle"+","+getPosition().x+","+getPosition().y+","
